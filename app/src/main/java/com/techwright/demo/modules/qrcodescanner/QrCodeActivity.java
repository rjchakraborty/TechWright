package com.techwright.demo.modules.qrcodescanner;
...
import com.techwright.demo.modules.qrcodescanner.camera.CameraManager;
import com.techwright.demo.modules.qrcodescanner.decode.CaptureActivityHandler;
import com.techwright.demo.modules.qrcodescanner.decode.DecodeImageCallback;
import com.techwright.demo.modules.qrcodescanner.decode.DecodeImageThread;
import com.techwright.demo.modules.qrcodescanner.decode.DecodeManager;
import com.techwright.demo.modules.qrcodescanner.decode.InactivityTimer;
import com.techwright.demo.modules.qrcodescanner.view.QrCodeFinderView;
...
public class QrCodeActivity extends Activity implements Callback, OnClickListener {
    ...
    private void handleResult(String resultString) {
        if (TextUtils.isEmpty(resultString)) {
            ...
            Log.d(AppConstants.LOGTAG, "Got scan result from user loaded image :" + resultString);
    ...
    private DecodeImageCallback mDecodeImageCallback = new DecodeImageCallback() {
        ...
        public void decodeSucceed(Result result) {
            ...
            Log.d(AppConstants.LOGTAG, "Decoded the image successfully :" + result.getText());
            Intent data = new Intent();
            data.putExtra(AppConstants.GOT_RESULT, result.getText());
            setResult(Activity.RESULT_OK, data);
            finish();
        }
        ...
        public void decodeFail(int type, String reason) {
            Log.d(AppConstants.LOGTAG, "Something went wrong decoding the image :" + reason);
            Intent data = new Intent();
            data.putExtra(AppConstants.ERROR_DECODING_IMAGE, reason);
    ...
    private static class WeakHandler extends Handler {
        ...
        private void handleResult(String resultString) {
            //Toasty.info(TEA.getAppContext(), resultString).show();
